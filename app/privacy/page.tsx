        ...
        >
          ...
          <div className="prose prose-lg max-w-none text-[#333]">
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">1. Introduction</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">2. Information We Collect</h2>

              <h3 className="text-xl font-semibold text-[#111] mb-3 mt-6">2.1 Personal Information</h3>
              <p className="mb-4 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-[#111] mb-3 mt-6">2.2 Automatically Collected Information</h3>
              <p className="mb-4 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-[#111] mb-3 mt-6">2.3 Cookies and Tracking Technologies</h3>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">3. How We Use Your Information</h2>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">4. How We Share Your Information</h2>
              <p className="mb-4 leading-relaxed">
                We may share your information in the following circumstances:
              </p>

              <h3 className="text-xl font-semibold text-[#111] mb-3 mt-6">4.1 Service Providers</h3>
              <p className="mb-4 leading-relaxed">
              ...
              <h3 className="text-xl font-semibold text-[#111] mb-3 mt-6">4.2 Legal Requirements</h3>
              <p className="mb-4 leading-relaxed">
                We may disclose your information if required to do so by law or in response to valid requests by public authorities.
              </p>

              <h3 className="text-xl font-semibold text-[#111] mb-3 mt-6">4.3 Business Transfers</h3>
              <p className="mb-4 leading-relaxed">
                If we are involved in a merger, acquisition, or sale of assets, your information may be transferred as part of that transaction.
              </p>

              <h3 className="text-xl font-semibold text-[#111] mb-3 mt-6">4.4 With Your Consent</h3>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">5. Data Security</h2>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">6. Data Retention</h2>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">7. Your Privacy Rights</h2>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">8. Third-Party Links</h2>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">9. Children's Privacy</h2>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">10. International Data Transfers</h2>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">11. Changes to This Privacy Policy</h2>
              <p className="mb-4 leading-relaxed">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-semibold text-[#111] mb-4">12. Contact Us</h2>
              <p className="mb-4 leading-relaxed">
